...
const template = (function (cjs, an) {
  ...
  (lib.char001 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(150).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(50));
  ...
  (lib.Symbol14 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(26).to({ _off: false }, 0).to({
      ...
      .to({ y: 461.3, startPosition: 13 }, 4, cjs.Ease.get(-1))
      .to({
        y: 485.8,
        startPosition: 17,
      }, 4, cjs.Ease.get(1))
      .wait(104)
      .to({ startPosition: 121 }, 0)
      .to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.0962, scaleY: 1.0962, x: 460.15 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
        x: 460.2,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.0899, scaleY: 1.0899, y: 446.45 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
        y: 446.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.0769, scaleY: 1.0769 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
      }, 4, cjs.Ease.get(1))
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(25).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.0689, scaleY: 1.0689 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
      }, 4, cjs.Ease.get(1))
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({ _off: false }, 0).to({ y: -62.5 }, 10, cjs.Ease.get(1))
      .wait(118)
      .to({ startPosition: 0 }, 0)
      .to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).to({ y: 519.95 }, 14, cjs.Ease.get(1)).wait(133).to({ startPosition: 0 }, 0)
      .to({ _off: true }, 1)
      .wait(29));
  ...
  (lib.IndustryCompany4 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape10).wait(8).to({ x: -658.5 }, 15, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(134)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape9).wait(12).to({ x: -658.5 }, 15, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(127)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape8).wait(14).to({ x: -658.5 }, 15, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(122)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(75).to({
      x: -288.2,
      alpha: 1,
    }, 0).to({ x: 348.8 }, 10, cjs.Ease.get(1))
      .to({ x: 321.6 }, 5, cjs.Ease.get(-1))
      .to({ x: 299.8 }, 4, cjs.Ease.get(1))
      .wait(83));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(28).to({ _off: false }, 0).to({ _off: true }, 148)
      .wait(1));
