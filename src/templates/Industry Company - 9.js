...
// helper functions:
  ...
  (lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off: false}, 0).to({
      regY: 234.4,
      scaleX: 1.124,
      scaleY: 1.124,
      x: 301.7,
      y: 410.1
    }, 12, cjs.Ease.get(1)).to({scaleX: 1.062, scaleY: 1.062, y: 410.15}, 5, cjs.Ease.get(-1)).to({
      scaleX: 1,
      scaleY: 1,
      y: 410.1
    }, 5, cjs.Ease.get(1)).wait(130).to({startPosition: 0}, 0).to({_off: true}, 1).wait(24));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off: false}, 0).to({
      ...
      scaleX: 1.1044,
      scaleY: 1.1044
    }, 12, cjs.Ease.get(1)).to({scaleX: 1.0522, scaleY: 1.0522, x: -104.1}, 5, cjs.Ease.get(-1)).to({
      scaleX: 1,
      scaleY: 1,
      x: -104.05
    }, 5, cjs.Ease.get(1)).wait(135).to({startPosition: 0}, 0).to({_off: true}, 1).wait(24));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).to({
      scaleX: 1.1363,
      scaleY: 1.1363
    }, 12, cjs.Ease.get(1)).to({scaleX: 1.0682, scaleY: 1.0682, y: 388.25}, 5, cjs.Ease.get(-1)).to({
      scaleX: 1,
      scaleY: 1,
      y: 388.2
    }, 5, cjs.Ease.get(1)).wait(139).to({startPosition: 0}, 0).to({_off: true}, 1).wait(24));
  ...
  (lib.char001 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      ...
      x: 92,
      y: -46.8
    }, 7, cjs.Ease.get(1)).wait(47).to({startPosition: 0}, 0).to({_off: true}, 1).wait(88));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      ...
      x: -12.1,
      y: 75.25
    }, 7, cjs.Ease.get(1)).wait(54).to({startPosition: 0}, 0).to({_off: true}, 1).wait(88));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(140).to({_off: false}, 0).to({
      ...
      x: 99.55,
      y: 45.5
    }, 7, cjs.Ease.get(1)).wait(54).to({rotation: -6.1618}, 0).to({_off: true}, 1).wait(88));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      ...
      x: 166.5,
      y: 81.9
    }, 5, cjs.Ease.get(1)).wait(121).to({startPosition: 0}, 0).to({_off: true}, 1).wait(88));
...
// stage content:
  (lib.IndustryCompany9 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape10).wait(9).to({
      ...
      x: 2059.45,
      y: 359.65
    }, 16, cjs.Ease.get(-1)).wait(1).to({x: -756.55, alpha: 0}, 0).wait(157).to({
      regY: 360.2,
      scaleY: 0.3229,
      rotation: 0,
      skewX: -0.0812,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape12).wait(13).to({
      regY: 360.1,
      scaleY: 0.5194,
      rotation: -0.0522,
      x: 2059.45,
      y: 359.6
    }, 16, cjs.Ease.get(-1)).wait(1).to({x: -756.55, alpha: 0}, 0).wait(149).to({
      regY: 360.2,
      scaleY: 0.3254,
      rotation: 0,
      skewX: -0.0833,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape13).wait(15).to({
      scaleY: 0.5128,
      rotation: -0.0512,
      x: 2059.5,
      y: 359.65
    }, 16, cjs.Ease.get(-1)).wait(1).to({x: -756.5, alpha: 0}, 0).wait(145).to({
      regY: 360.2,
      scaleY: 0.3212,
      rotation: 0,
      skewX: -0.0816,
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(89).to({
      y: -113.7,
      alpha: 1
    }, 0).to({y: 158.3}, 10, cjs.Ease.get(1)).to({y: 142.3}, 5, cjs.Ease.get(-1)).to({y: 126.3}, 5, cjs.Ease.get(1)).wait(93));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(86).to({
      y: -32.5,
      alpha: 1
    }, 0).to({y: 239.5}, 10, cjs.Ease.get(1)).to({y: 223.5}, 5, cjs.Ease.get(-1)).to({y: 207.5}, 5, cjs.Ease.get(1)).wait(96));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(61).to({_off: false}, 0).to({
      regY: 398.9,
      y: 641.4,
      startPosition: 78
    }, 9, cjs.Ease.get(1)).to({regY: 398.7, y: 650, startPosition: 82}, 4, cjs.Ease.get(-1)).to({
      regY: 398.8,
      y: 660.85,
      startPosition: 87,
      loop: false
    }, 5, cjs.Ease.get(1)).to({_off: true}, 122).wait(1));
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape1).wait(28).to({
      y: 795.85,
      alpha: 1
    }, 0).to({y: 683.85}, 14, cjs.Ease.get(1)).wait(160));
