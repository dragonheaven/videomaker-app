...
const template = (function (cjs, an) {
  ...
  (lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.062, scaleY: 1.062, y: 410.15 }, 5, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
        y: 410.1,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({ _off: false }, 0).to({
      ...
      .to({ scaleX: 1.0522, scaleY: 1.0522, x: -104.1 }, 5, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
        x: -104.05,
  ...
  (lib.IndustryCompany9 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(89).to({
      y: -113.7,
      alpha: 1,
    }, 0).to({ y: 158.3 }, 10, cjs.Ease.get(1))
      .to({ y: 142.3 }, 5, cjs.Ease.get(-1))
      .to({ y: 126.3 }, 5, cjs.Ease.get(1))
      .wait(93));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(86).to({
      y: -32.5,
      alpha: 1,
    }, 0).to({ y: 239.5 }, 10, cjs.Ease.get(1))
      .to({ y: 223.5 }, 5, cjs.Ease.get(-1))
      .to({ y: 207.5 }, 5, cjs.Ease.get(1))
      .wait(96));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(61).to({ _off: false }, 0).to({
      ...
      .to({ regY: 398.7, y: 650, startPosition: 82 }, 4, cjs.Ease.get(-1))
      .to({
        regY: 398.8,
        y: 660.85,
        startPosition: 87,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({ _off: false }, 0).to({ _off: true }, 162)
      .wait(1));
