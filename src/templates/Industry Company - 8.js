...
// helper functions:
  ...
  (lib.char001 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      scaleX: 0.9998,
      scaleY: 0.9998,
      rotation: 2.8097,
      x: 103.85,
      ...
      x: 91.95,
      y: -84.75
    }, 5, cjs.Ease.get(1)).wait(60).to({regY: 86.5, y: -46.75}, 0).to({
      scaleX: 0.9998,
      scaleY: 0.9998,
      rotation: 2.7738,
      y: -46.7
      ...
      x: 92,
      y: -46.8
    }, 7, cjs.Ease.get(1)).wait(38).to({startPosition: 0}, 0).to({_off: true}, 1).wait(97));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      scaleX: 0.9998,
      scaleY: 0.9998,
      rotation: 4.3109,
      x: 10.25,
      ...
      x: 0.4,
      y: 78.1
    }, 6, cjs.Ease.get(1)).wait(29).to({startPosition: 0}, 0).to({
      regY: 8.1,
      scaleX: 0.9994,
      scaleY: 0.9994,
      rotation: -80.4338,
      ...
      x: -12.1,
      y: 75.25
    }, 7, cjs.Ease.get(1)).wait(45).to({startPosition: 0}, 0).to({_off: true}, 1).wait(97));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      scaleX: 0.9995,
      scaleY: 0.9995,
      rotation: 9.0641,
      x: 28.15,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(109).to({_off: false}, 0).to({
      ...
      rotation: 14.9985,
      x: 113.9
    }, 7, cjs.Ease.get(1)).to({_off: true}, 17).wait(157));
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(140).to({_off: false}, 0).to({
      ...
      x: 99.55,
      y: 45.5
    }, 7, cjs.Ease.get(1)).wait(45).to({rotation: -6.1618}, 0).to({_off: true}, 1).wait(97));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      skewX: 1.274,
      skewY: -178.726,
      x: 187.05,
      y: 82.45
      ...
      x: 166.5,
      y: 81.9
    }, 5, cjs.Ease.get(1)).wait(112).to({startPosition: 0}, 0).to({_off: true}, 1).wait(97));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      regY: 14.5,
      scaleX: 0.9994,
      scaleY: 0.9994,
      skewX: -10.7585,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      regY: 207.4,
      scaleX: 0.9998,
      scaleY: 0.9998,
      rotation: 2.8097,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      regX: 22.5,
      scaleX: 0.9994,
      scaleY: 0.9994,
      rotation: -11.0493,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      scaleX: 0.9991,
      scaleY: 0.9991,
      rotation: 16.2932,
      x: 139.9,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      regY: 11,
      scaleX: 0.9991,
      scaleY: 0.9991,
      skewX: 16.2932,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(67).to({_off: false}, 0).wait(8).to({startPosition: 0}, 0).to({_off: true}, 1).wait(2).to({_off: false}, 0).to({
      scaleX: 0.9993,
      scaleY: 0.9993,
      skewX: -12.0417,
      skewY: 167.9583,
...
// stage content:
  (lib.IndustryCompany8 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape10).wait(9).to({
      ...
      x: -756.55,
      y: 359.65
    }, 16, cjs.Ease.get(-1)).wait(1).to({alpha: 0}, 0).wait(141).to({
      regY: 360.2,
      scaleY: 0.3229,
      rotation: 0,
      skewX: -0.0812,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape12).wait(14).to({
      ...
      x: -756.55,
      y: 359.6
    }, 16, cjs.Ease.get(-1)).wait(1).to({alpha: 0}, 0).wait(132).to({
      regY: 360.2,
      scaleY: 0.3254,
      rotation: 0,
      skewX: -0.0833,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape13).wait(16).to({
      ...
      x: -756.5,
      y: 359.65
    }, 16, cjs.Ease.get(-1)).wait(1).to({alpha: 0}, 0).wait(128).to({
      regY: 360.2,
      scaleY: 0.3212,
      rotation: 0,
      skewX: -0.0816,
    ...
    this.timeline.addTween(cjs.Tween.get(mask).to({
      ...
      x: 336.575,
      y: 171.775
    }).wait(76).to({graphics: mask_graphics_76, x: 336.575, y: 171.775}).wait(9).to({
      graphics: mask_graphics_85,
      x: 336.575,
      y: 171.775
    }).wait(10).to({graphics: mask_graphics_95, x: 336.575, y: 171.775}).wait(91));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(76).to({
      y: 389.35,
      alpha: 1
    }, 0).to({y: 289.35}, 9, cjs.Ease.get(1)).to({y: 301.85}, 5, cjs.Ease.get(-1)).to({y: 314.35}, 5, cjs.Ease.get(1)).wait(91));
    ...
    this.timeline.addTween(cjs.Tween.get(mask_1).to({
      ...
      x: 336.575,
      y: 326.425
    }).wait(76).to({graphics: mask_1_graphics_76, x: 336.575, y: 326.425}).wait(9).to({
      graphics: mask_1_graphics_85,
      x: 336.575,
      y: 326.425
    }).wait(10).to({graphics: mask_1_graphics_95, x: 336.575, y: 326.425}).wait(91));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(76).to({
      y: 324.85,
      alpha: 1
    }, 0).to({y: 412.35}, 9, cjs.Ease.get(1)).to({y: 399.85}, 5, cjs.Ease.get(-1)).to({y: 387.35}, 5, cjs.Ease.get(1)).wait(91));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(54).to({_off: false}, 0).to({
      y: 614.75,
      startPosition: 78
    }, 9, cjs.Ease.get(1)).to({y: 625.15, startPosition: 82}, 4, cjs.Ease.get(-1)).to({
      y: 638.15,
      startPosition: 87,
      loop: false
    }, 5, cjs.Ease.get(1)).to({_off: true}, 113).wait(1));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({_off: false}, 0).to({
      ...
      scaleX: 1.1392,
      scaleY: 1.1392
    }, 10, cjs.Ease.get(1)).to({scaleX: 1.0696, scaleY: 1.0696}, 5, cjs.Ease.get(-1)).to({
      scaleX: 1,
      scaleY: 1
    }, 5, cjs.Ease.get(1)).to({_off: true}, 126).wait(1));
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape1).wait(28).to({
      y: 795.85,
      alpha: 1
    }, 0).to({y: 683.85}, 14, cjs.Ease.get(1)).wait(144));
