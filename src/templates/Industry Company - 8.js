...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(67).to({_off:false},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9998,scaleY:0.9998,rotation:4.3109,x:10.25,y:75.75},4,cjs.Ease.get(-1)).to({regX:14.7,scaleX:1,scaleY:1,rotation:0,x:14.8,y:81.9},5,cjs.Ease.get(1)).wait(12).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,rotation:-33.8642,x:7.65,y:80},6,cjs.Ease.get(-1)).to({regY:8.2,scaleX:1,scaleY:1,rotation:-67.9453,x:0.4,y:78.1},6,cjs.Ease.get(1)).wait(29).to({startPosition:0},0).to({regY:8.1,scaleX:0.9994,scaleY:0.9994,rotation:-80.4338,x:-5.8,y:76.65},7,cjs.Ease.get(-1)).to({regY:8.2,scaleX:1,scaleY:1,rotation:-92.5608,x:-12.1,y:75.25},7,cjs.Ease.get(1)).wait(45).to({startPosition:0},0).to({_off:true},1).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(140).to({_off:false},0).to({regX:66.1,scaleX:0.453,scaleY:0.453,rotation:4.2929,x:106.7,y:71.3},7,cjs.Ease.get(-1)).to({regY:100,scaleX:0.4531,scaleY:0.4531,rotation:-6.1618,x:99.55,y:45.5},7,cjs.Ease.get(1)).wait(45).to({rotation:-6.1618},0).to({_off:true},1).wait(97));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape10).wait(9).to({regY:360.1,scaleY:0.5154,rotation:-0.0509,x:-756.55,y:359.65},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(141).to({regY:360.2,scaleY:0.3229,rotation:0,skewX:-0.0812,skewY:-0.0041,x:-752.05,y:359.45,alpha:1},0).to({regY:360,scaleY:1.0865,rotation:-0.0241,skewX:0,skewY:0,x:639.95,y:360},16,cjs.Ease.get(1)).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape12).wait(14).to({regY:360.1,scaleY:0.5194,rotation:-0.0522,x:-756.55,y:359.6},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(132).to({regY:360.2,scaleY:0.3254,rotation:0,skewX:-0.0833,skewY:-0.0041,x:-752.05,y:359.45,alpha:1},0).to({regY:360,scaleY:1.0948,rotation:-0.0248,skewX:0,skewY:0,x:639.95,y:360},16,cjs.Ease.get(1)).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape13).wait(16).to({scaleY:0.5128,rotation:-0.0512,x:-756.5,y:359.65},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(128).to({regY:360.2,scaleY:0.3212,rotation:0,skewX:-0.0816,skewY:-0.0041,x:-752,y:359.45,alpha:1},0).to({regY:360.1,scaleY:1.0809,rotation:-0.0243,skewX:0,skewY:0,x:640,y:360.05},16,cjs.Ease.get(1)).wait(9));

	// mask_idn (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Eg3vAa2MAAAgnNMBvfAAAMAAAAnNg");
	var mask_graphics_76 = new cjs.Graphics().p("Eg3vAa2MAAAgnNMBvfAAAMAAAAnNg");
	var mask_graphics_85 = new cjs.Graphics().p("Eg3vAa2MAAAgnNMBvfAAAMAAAAnNg");
	var mask_graphics_95 = new cjs.Graphics().p("Eg3vAa2MAAAgnNMBvfAAAMAAAAnNg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:336.575,y:171.775}).wait(76).to({graphics:mask_graphics_76,x:336.575,y:171.775}).wait(9).to({graphics:mask_graphics_85,x:336.575,y:171.775}).wait(10).to({graphics:mask_graphics_95,x:336.575,y:171.775}).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.text1).wait(76).to({y:389.35,alpha:1},0).to({y:289.35},9,cjs.Ease.get(1)).to({y:301.85},5,cjs.Ease.get(-1)).to({y:314.35},5,cjs.Ease.get(1)).wait(91));

	// mask_idn (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("Eg3vAzAMAAAgwVMBvfAAAMAAAAwVg");
	var mask_1_graphics_76 = new cjs.Graphics().p("Eg3vAzAMAAAgwVMBvfAAAMAAAAwVg");
	var mask_1_graphics_85 = new cjs.Graphics().p("Eg3vAzAMAAAgwVMBvfAAAMAAAAwVg");
	var mask_1_graphics_95 = new cjs.Graphics().p("Eg3vAzAMAAAgwVMBvfAAAMAAAAwVg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:336.575,y:326.425}).wait(76).to({graphics:mask_1_graphics_76,x:336.575,y:326.425}).wait(9).to({graphics:mask_1_graphics_85,x:336.575,y:326.425}).wait(10).to({graphics:mask_1_graphics_95,x:336.575,y:326.425}).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.text2).wait(76).to({y:324.85,alpha:1},0).to({y:412.35},9,cjs.Ease.get(1)).to({y:399.85},5,cjs.Ease.get(-1)).to({y:387.35},5,cjs.Ease.get(1)).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(54).to({_off:false},0).to({y:614.75,startPosition:78},9,cjs.Ease.get(1)).to({y:625.15,startPosition:82},4,cjs.Ease.get(-1)).to({y:638.15,startPosition:87,loop:false},5,cjs.Ease.get(1)).to({_off:true},113).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({_off:false},0).to({regY:706.9,scaleX:1.1392,scaleY:1.1392},10,cjs.Ease.get(1)).to({scaleX:1.0696,scaleY:1.0696},5,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1},5,cjs.Ease.get(1)).to({_off:true},126).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape1).wait(28).to({y:795.85,alpha:1},0).to({y:683.85},14,cjs.Ease.get(1)).wait(144));
