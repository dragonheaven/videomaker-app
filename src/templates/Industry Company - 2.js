...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regY:56.4,skewX:5.0294,skewY:185.0294,x:161.9,y:130},0).wait(1).to({skewX:20.1176,skewY:200.1176,x:148.6,y:127.25},0).wait(1).to({skewX:45.2645,skewY:225.2645,x:129.35,y:115.9},0).wait(1).to({skewX:80.4703,skewY:260.4703,x:113.85,y:89.95},0).wait(1).to({regY:8.2,skewX:125.7348,skewY:305.7348,x:158.65,y:81.95},0).wait(1).to({regY:8.1,rotation:178.7549,skewX:0,skewY:360,x:165.7,y:76.85},0).wait(1).to({regY:56.4,rotation:195.0479,x:187.8,y:26.65},0).wait(1).to({rotation:206.6857,x:203.8,y:27.5},0).wait(1).to({rotation:213.6684,x:212.95,y:28.95},0).wait(1).to({regY:8.1,rotation:215.9959,x:187.6,y:68.65},0).wait(1).to({regY:56.4,scaleX:0.9999,scaleY:0.9999,rotation:214.8367,x:214.7,y:29.3},0).wait(1).to({scaleX:0.9994,scaleY:0.9994,rotation:211.3588,x:210.75,y:28.75},0).wait(1).to({regY:8.1,scaleX:0.9987,scaleY:0.9987,rotation:205.5624,x:183.15,y:71.65},0).wait(13).to({startPosition:0},0).to({scaleX:0.9972,scaleY:0.9972,rotation:211.3103,x:225.45,y:30.65},8,cjs.Ease.get(-1)).to({scaleX:0.9987,scaleY:0.9987,rotation:216.2923,x:222.8,y:-33.65},7,cjs.Ease.get(1)).wait(16).to({startPosition:0},0).to({scaleX:0.997,scaleY:0.997,rotation:224.6131,x:227.15,y:-7.15},7,cjs.Ease.get(-1)).to({regY:8,scaleX:0.9987,scaleY:0.9987,rotation:234.0513,x:232.3,y:23.2},8,cjs.Ease.get(1)).wait(74).to({startPosition:0},0).to({_off:true},1).wait(29));

	// Layer_3
	this.instance_3 = new lib.bicep001("synched",0);
	this.instance_3.setTransform(160.25,7.1,1,1,0,0,180,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:18.5,regY:49.7,skewX:0.2294,skewY:180.2294,x:162.25,y:42.35},0).wait(1).to({skewX:0.9175,skewY:180.9175,x:161.8,y:42.3},0).wait(1).to({skewX:2.0643,skewY:182.0643,x:161.05},0).wait(1).to({skewX:3.6699,skewY:183.6699,x:160,y:42.2},0).wait(1).to({regX:20.7,regY:14.5,skewX:5.7343,skewY:185.7343,x:159.95,y:6.9},0).wait(1).to({regX:18.5,regY:49.7,skewX:-1.7298,skewY:178.2702,x:162.8,y:41.8},0).wait(1).to({skewX:-7.5351,skewY:172.4649,x:166.05,y:41.1},0).wait(1).to({skewX:-11.6818,skewY:168.3182,x:168.35,y:40.4},0).wait(1).to({skewX:-14.1698,skewY:165.8302,x:169.65,y:39.95},0).wait(1).to({regX:20.7,regY:14.5,skewX:-14.9992,skewY:165.0008,x:158.9,y:6.2},0).wait(1).to({regX:18.5,regY:49.7,scaleX:0.9999,scaleY:0.9999,skewX:-14.5893,skewY:165.4107,x:169.85,y:39.75},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,skewX:-13.3597,skewY:166.6403,x:169.15,y:39.95},0).wait(1).to({regX:20.7,regY:14.5,scaleX:0.9994,scaleY:0.9994,skewX:-11.3104,skewY:168.6896,x:158.85,y:6.2},0).wait(13).to({startPosition:0},0).to({scaleX:0.9982,scaleY:0.9982,skewX:-67.4252,skewY:112.5748,x:158.8,y:6.25},8,cjs.Ease.get(-1)).to({scaleX:0.9994,scaleY:0.9994,skewX:-116.3092,skewY:63.6908,x:158.9},7,cjs.Ease.get(1)).wait(16).to({startPosition:0},0).to({scaleX:0.999,scaleY:0.999,skewX:-95.2669,skewY:84.7331},7,cjs.Ease.get(-1)).to({scaleX:0.9993,scaleY:0.9993,skewX:-71.31,skewY:108.69},8,cjs.Ease.get(1)).wait(74).to({startPosition:0},0).to({_off:true},1).wait(29));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(42).to({startPosition:0},0).to({regY:76.7,scaleX:0.9997,scaleY:0.9997,rotation:5.2905,x:36.65,y:0.4},6,cjs.Ease.get(-1)).to({regY:76.6,scaleX:1,scaleY:1,rotation:11.7099,x:36.6,y:0.3},7,cjs.Ease.get(1)).wait(24).to({startPosition:0},0).to({regY:76.7,scaleX:0.9997,scaleY:0.9997,rotation:5.2695,y:0.4},6,cjs.Ease.get(-1)).to({regY:76.6,scaleX:1,scaleY:1,rotation:0,y:0.35},5,cjs.Ease.get(1)).wait(85).to({startPosition:0},0).to({_off:true},1).wait(79));

	// Layer_3
	this.instance_1 = new lib.zasxzas("synched",0);
	this.instance_1.setTransform(39.7,56,1,1,0,0,0,69.2,15.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(60).to({startPosition:0},0).to({regY:15.2,rotation:-7.2425,y:56.1},13).wait(102).to({startPosition:0},0).to({_off:true},1).wait(79));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(20).to({graphics:mask_graphics_20,x:41.5989,y:157.1}).wait(1).to({graphics:mask_graphics_21,x:42.5982,y:157.1}).wait(1).to({graphics:mask_graphics_22,x:45.5962,y:157.1}).wait(1).to({graphics:mask_graphics_23,x:50.5928,y:157.1}).wait(1).to({graphics:mask_graphics_24,x:57.5881,y:157.1}).wait(1).to({graphics:mask_graphics_25,x:66.582,y:157.1}).wait(1).to({graphics:mask_graphics_26,x:75.9887,y:157.1}).wait(1).to({graphics:mask_graphics_27,x:75.985,y:157.1}).wait(1).to({graphics:mask_graphics_28,x:75.9807,y:157.1}).wait(1).to({graphics:mask_graphics_29,x:75.9749,y:157.1}).wait(1).to({graphics:mask_graphics_30,x:75.9697,y:157.1}).wait(1).to({graphics:mask_graphics_31,x:75.965,y:157.1}).wait(1).to({graphics:mask_graphics_32,x:75.9611,y:157.1}).wait(1).to({graphics:mask_graphics_33,x:75.9577,y:157.1}).wait(1).to({graphics:mask_graphics_34,x:75.9549,y:157.1}).wait(1).to({graphics:mask_graphics_35,x:75.9528,y:157.1}).wait(1).to({graphics:mask_graphics_36,x:75.9512,y:157.1}).wait(1).to({graphics:mask_graphics_37,x:75.9503,y:157.1}).wait(1).to({graphics:mask_graphics_38,x:76,y:157.1}).wait(87));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:51.075,y:-22.225}).wait(1).to({graphics:mask_1_graphics_1,x:51.075,y:-14.6126}).wait(1).to({graphics:mask_1_graphics_2,x:51.075,y:0.4492}).wait(1).to({graphics:mask_1_graphics_3,x:51.075,y:15.511}).wait(1).to({graphics:mask_1_graphics_4,x:51.075,y:30.5728}).wait(1).to({graphics:mask_1_graphics_5,x:51.075,y:45.6346}).wait(1).to({graphics:mask_1_graphics_6,x:51.075,y:60.6964}).wait(1).to({graphics:mask_1_graphics_7,x:51.075,y:75.7583}).wait(1).to({graphics:mask_1_graphics_8,x:51.075,y:90.8201}).wait(1).to({graphics:mask_1_graphics_9,x:51.075,y:105.8819}).wait(1).to({graphics:mask_1_graphics_10,x:51.075,y:120.9437}).wait(1).to({graphics:mask_1_graphics_11,x:51.075,y:136.0055}).wait(1).to({graphics:mask_1_graphics_12,x:51.075,y:151.0673}).wait(1).to({graphics:mask_1_graphics_13,x:51.075,y:166.1291}).wait(1).to({graphics:mask_1_graphics_14,x:51.075,y:181.1909}).wait(1).to({graphics:mask_1_graphics_15,x:51.075,y:196.2528}).wait(1).to({graphics:mask_1_graphics_16,x:51.075,y:211.3146}).wait(1).to({graphics:mask_1_graphics_17,x:51.075,y:226.3764}).wait(1).to({graphics:mask_1_graphics_18,x:51.075,y:241.4382}).wait(1).to({graphics:mask_1_graphics_19,x:51.075,y:256.95}).wait(106));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(46).to({_off:false},0).to({y:217.3,startPosition:11},11,cjs.Ease.get(1)).to({y:233.3,startPosition:15},4,cjs.Ease.get(-1)).to({y:253.3,startPosition:20},5,cjs.Ease.get(1)).wait(128).to({startPosition:148},0).to({_off:true},1).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50).to({_off:false},0).to({y:406.85,startPosition:11},11,cjs.Ease.get(1)).to({y:422.85,startPosition:15},4,cjs.Ease.get(-1)).to({y:442.85,startPosition:20},5,cjs.Ease.get(1)).wait(124).to({startPosition:144},0).to({_off:true},1).wait(27));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape10).wait(6).to({x:640},0).to({regY:359.8,scaleY:0.0511,x:640.05,y:360},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(179).to({alpha:1},0).to({regY:360,scaleY:1.8473,x:640,y:359.95},17,cjs.Ease.get(1)).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape12).wait(10).to({regY:358.9,scaleY:0.0307,skewX:-32.6941,y:359.95},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(171).to({alpha:1},0).to({regY:360,scaleY:1.8615,skewX:-32.6892,y:360},17,cjs.Ease.get(1)).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape13).wait(12).to({regY:358.4,scaleY:0.0508,skewX:-32.6877,y:359.85},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(167).to({alpha:1},0).to({regY:360,scaleY:1.8378,skewX:-32.689,y:359.95},17,cjs.Ease.get(1)).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:653.425,y:175.475}).wait(98).to({graphics:mask_graphics_98,x:653.425,y:175.475}).wait(11).to({graphics:mask_graphics_109,x:653.425,y:175.475}).wait(9).to({graphics:mask_graphics_118,x:653.425,y:175.475}).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.text1).wait(98).to({y:428.75,alpha:1},0).to({y:268.55},11,cjs.Ease.get(1)).to({y:286.55},5,cjs.Ease.get(-1)).to({y:304.55},4,cjs.Ease.get(1)).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:653.425,y:255.525}).wait(98).to({graphics:mask_1_graphics_98,x:653.425,y:255.525}).wait(11).to({graphics:mask_1_graphics_109,x:653.425,y:255.525}).wait(9).to({graphics:mask_1_graphics_118,x:653.425,y:255.525}).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.text2).wait(98).to({y:318.05,alpha:1},0).to({y:433.25},11,cjs.Ease.get(1)).to({y:413.25},5,cjs.Ease.get(-1)).to({y:397.25},4,cjs.Ease.get(1)).wait(104));
