...
const template = (function (cjs, an) {
  ...
  (lib.char001 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({ startPosition: 0 }, 0).wait(1)
      ...
      .wait(1)
      .to({
        skewX: 20.1176, skewY: 200.1176, x: 148.6, y: 127.25,
      }, 0)
      .wait(1)
      .to({
        skewX: 45.2645,
      ...
      .wait(1)
      .to({
        skewX: 80.4703, skewY: 260.4703, x: 113.85, y: 89.95,
      }, 0)
      .wait(1)
      .to({
        regY: 8.2,
      ...
      .wait(1)
      .to({
        regY: 56.4, rotation: 195.0479, x: 187.8, y: 26.65,
      }, 0)
      .wait(1)
      .to({
        rotation: 206.6857,
      ...
      .wait(1)
      .to({ rotation: 213.6684, x: 212.95, y: 28.95 }, 0)
      .wait(1)
      .to({
        regY: 8.1,
        rotation: 215.9959,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({ startPosition: 0 }, 0).wait(1)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 18.5,
      ...
      .wait(1)
      .to({
        skewX: 0.9175, skewY: 180.9175, x: 161.8, y: 42.3,
      }, 0)
      .wait(1)
      .to({
        skewX: 2.0643,
      ...
      .wait(1)
      .to({
        skewX: 3.6699, skewY: 183.6699, x: 160, y: 42.2,
      }, 0)
      .wait(1)
      .to({
        regX: 20.7,
      ...
      .wait(1)
      .to({
        skewX: -7.5351, skewY: 172.4649, x: 166.05, y: 41.1,
      }, 0)
      .wait(1)
      .to({
        skewX: -11.6818,
      ...
      .wait(1)
      .to({
        skewX: -14.1698, skewY: 165.8302, x: 169.65, y: 39.95,
      }, 0)
      .wait(1)
      .to({
        regX: 20.7,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(171).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(29));
  ...
  (lib.asdsaw = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(175).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(79));
  ...
  (lib.asdsa = function (mode, startPosition, loop, reversed) {
    ...
    mask._off = true;
    const mask_graphics_20 = new cjs.Graphics().p('AEQaDMAAAg0FICQAAMAAAA0Fg');
    const mask_graphics_21 = new cjs.Graphics().p('ADyaDMAAAg0FIC4AAMAAAA0Fg');
    const mask_graphics_22 = new cjs.Graphics().p('ACYaDMAAAg0FIEwAAMAAAA0Fg');
    const mask_graphics_23 = new cjs.Graphics().p('AACaDMAAAg0FIH4AAMAAAA0Fg');
    const mask_graphics_24 = new cjs.Graphics().p('AjPaDMAAAg0FIMPAAMAAAA0Fg');
    const mask_graphics_25 = new cjs.Graphics().p('AndaDMAAAg0FIR3AAMAAAA0Fg');
    const mask_graphics_26 = new cjs.Graphics().p('AsXaDMAAAg0FIYvAAMAAAA0Fg');
    const mask_graphics_27 = new cjs.Graphics().p('AwaaDMAAAg0FMAg1AAAMAAAA0Fg');
    const mask_graphics_28 = new cjs.Graphics().p('A1GaDMAAAg0FMAqNAAAMAAAA0Fg');
    const mask_graphics_29 = new cjs.Graphics().p('A52aDMAAAg0FMAztAAAMAAAA0Fg');
    const mask_graphics_30 = new cjs.Graphics().p('A+GaDMAAAg0FMA8NAAAMAAAA0Fg');
    const mask_graphics_31 = new cjs.Graphics().p('Egh2AaDMAAAg0FMBDtAAAMAAAA0Fg');
    const mask_graphics_32 = new cjs.Graphics().p('EglGAaDMAAAg0FMBKNAAAMAAAA0Fg');
    const mask_graphics_33 = new cjs.Graphics().p('Egn2AaDMAAAg0FMBPtAAAMAAAA0Fg');
    const mask_graphics_34 = new cjs.Graphics().p('EgqGAaDMAAAg0FMBUNAAAMAAAA0Fg');
    const mask_graphics_35 = new cjs.Graphics().p('Egr2AaDMAAAg0FMBXtAAAMAAAA0Fg');
    const mask_graphics_36 = new cjs.Graphics().p('EgtGAaDMAAAg0FMBaNAAAMAAAA0Fg');
    const mask_graphics_37 = new cjs.Graphics().p('Egt2AaDMAAAg0FMBbtAAAMAAAA0Fg');
    const mask_graphics_38 = new cjs.Graphics().p('EguGAaDMAAAg0FMBcNAAAMAAAA0Fg');
    ...
    this.timeline.addTween(cjs.Tween.get(mask).to({ graphics: null, x: 0, y: 0 }).wait(20).to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_21, x: 42.5982, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_23, x: 50.5928, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_25, x: 66.582, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_27, x: 75.985, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_29, x: 75.9749, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_31, x: 75.965, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_33, x: 75.9577, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_35, x: 75.9528, y: 157.1 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_graphics_37, x: 75.9503, y: 157.1 })
      .wait(1)
      .to({
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({ _off: false }, 0).wait(18)
      .to({ startPosition: 0 }, 0)
      .wait(87));
    ...
    mask_1._off = true;
    const mask_1_graphics_0 = new cjs.Graphics().p('A7JBJIAAkmMA2TAAAIAAEmg');
    const mask_1_graphics_1 = new cjs.Graphics().p('A7JEjIAApFMA2TAAAIAAJFg');
    const mask_1_graphics_2 = new cjs.Graphics().p('A7JGxIAAthMA2TAAAIAANhg');
    const mask_1_graphics_3 = new cjs.Graphics().p('A7JJAIAAx/MA2TAAAIAAR/g');
    const mask_1_graphics_4 = new cjs.Graphics().p('A7JLPIAA2dMA2TAAAIAAWdg');
    const mask_1_graphics_5 = new cjs.Graphics().p('A7JNeIAA67MA2TAAAIAAa7g');
    const mask_1_graphics_6 = new cjs.Graphics().p('A7JPtIAA/ZMA2TAAAIAAfZg');
    const mask_1_graphics_7 = new cjs.Graphics().p('A7JR8MAAAgj3MA2TAAAMAAAAj3g');
    const mask_1_graphics_8 = new cjs.Graphics().p('A7JUKMAAAgoTMA2TAAAMAAAAoTg');
    const mask_1_graphics_9 = new cjs.Graphics().p('A7JWZMAAAgsxMA2TAAAMAAAAsxg');
    const mask_1_graphics_10 = new cjs.Graphics().p('A7JYoMAAAgxPMA2TAAAMAAAAxPg');
    const mask_1_graphics_11 = new cjs.Graphics().p('A7Ja3MAAAg1tMA2TAAAMAAAA1tg');
    const mask_1_graphics_12 = new cjs.Graphics().p('A7JdGMAAAg6LMA2TAAAMAAAA6Lg');
    const mask_1_graphics_13 = new cjs.Graphics().p('A7JfVMAAAg+pMA2TAAAMAAAA+pg');
    const mask_1_graphics_14 = new cjs.Graphics().p('EgbJAhjMAAAhDFMA2TAAAMAAABDFg');
    const mask_1_graphics_15 = new cjs.Graphics().p('EgbJAjyMAAAhHjMA2TAAAMAAABHjg');
    const mask_1_graphics_16 = new cjs.Graphics().p('EgbJAmBMAAAhMBMA2TAAAMAAABMBg');
    const mask_1_graphics_17 = new cjs.Graphics().p('EgbJAoQMAAAhQfMA2TAAAMAAABQfg');
    const mask_1_graphics_18 = new cjs.Graphics().p('EgbJAqfMAAAhU9MA2TAAAMAAABU9g');
    const mask_1_graphics_19 = new cjs.Graphics().p('EgbJAstMAAAhZZMA2TAAAMAAABZZg');

    this.timeline.addTween(cjs.Tween.get(mask_1).to({
      graphics: mask_1_graphics_0,
      x: 51.075,
      y: -22.225,
    }).wait(1).to({ graphics: mask_1_graphics_1, x: 51.075, y: -14.6126 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_3, x: 51.075, y: 15.511 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_5, x: 51.075, y: 45.6346 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_7, x: 51.075, y: 75.7583 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_9, x: 51.075, y: 105.8819 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_11, x: 51.075, y: 136.0055 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_13, x: 51.075, y: 166.1291 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_15, x: 51.075, y: 196.2528 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_17, x: 51.075, y: 226.3764 })
      .wait(1)
      .to({
      ...
      .wait(1)
      .to({ graphics: mask_1_graphics_19, x: 51.075, y: 256.95 })
      .wait(106));
  ...
  (lib.fx1 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(46).to({ _off: false }, 0).to({
      ...
      .to({ y: 233.3, startPosition: 15 }, 4, cjs.Ease.get(-1))
      .to({
        y: 253.3,
        startPosition: 20,
      }, 5, cjs.Ease.get(1))
      .wait(128)
      .to({ startPosition: 148 }, 0)
      .to({ _off: true }, 1)
      .wait(27));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50).to({ _off: false }, 0).to({
      ...
      .to({ y: 422.85, startPosition: 15 }, 4, cjs.Ease.get(-1))
      .to({
        y: 442.85,
        startPosition: 20,
      }, 5, cjs.Ease.get(1))
      .wait(124)
      .to({ startPosition: 144 }, 0)
      .to({ _off: true }, 1)
      .wait(27));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(11).to({ _off: false }, 0).wait(183)
      .to({ startPosition: 124 }, 0)
      .to({ _off: true }, 1)
      .wait(27));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).to({ y: 467.85 }, 14, cjs.Ease.get(1)).wait(180).to({ startPosition: 0 }, 0)
      .to({ _off: true }, 1)
      .wait(27));
  ...
  (lib.IndustryCompany2 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(26).to({ _off: false }, 0).to({ _off: true }, 195)
      .wait(1));

    // Layer_11 (mask)
    const mask = new cjs.Shape();
    mask._off = true;
    const mask_graphics_0 = new cjs.Graphics().p('AiFbbIAA3xMBoLAAAIAAXxg');
    const mask_graphics_98 = new cjs.Graphics().p('AiFbbIAA3xMBoLAAAIAAXxg');
    const mask_graphics_109 = new cjs.Graphics().p('AiFbbIAA3xMBoLAAAIAAXxg');
    const mask_graphics_118 = new cjs.Graphics().p('AiFbbIAA3xMBoLAAAIAAXxg');

    this.timeline.addTween(cjs.Tween.get(mask).to({
      graphics: mask_graphics_0,
      x: 653.425,
      y: 175.475,
    }).wait(98).to({ graphics: mask_graphics_98, x: 653.425, y: 175.475 })
      .wait(11)
      .to({
      ...
      .wait(9)
      .to({ graphics: mask_graphics_118, x: 653.425, y: 175.475 })
      .wait(104));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(98).to({
      y: 428.75,
      alpha: 1,
    }, 0).to({ y: 268.55 }, 11, cjs.Ease.get(1))
      .to({ y: 286.55 }, 5, cjs.Ease.get(-1))
      .to({ y: 304.55 }, 4, cjs.Ease.get(1))
      .wait(104));

    // Layer_23 (mask)
    const mask_1 = new cjs.Shape();
    mask_1._off = true;
    const mask_1_graphics_0 = new cjs.Graphics().p('EgCFAn7IAA5BMBoLAAAIAAZBg');
    const mask_1_graphics_98 = new cjs.Graphics().p('EgCFAn7IAA5BMBoLAAAIAAZBg');
    const mask_1_graphics_109 = new cjs.Graphics().p('EgCFAn7IAA5BMBoLAAAIAAZBg');
    const mask_1_graphics_118 = new cjs.Graphics().p('EgCFAn7IAA5BMBoLAAAIAAZBg');

    this.timeline.addTween(cjs.Tween.get(mask_1).to({
      graphics: mask_1_graphics_0,
      x: 653.425,
      y: 255.525,
    }).wait(98).to({ graphics: mask_1_graphics_98, x: 653.425, y: 255.525 })
      .wait(11)
      .to({
      ...
      .wait(9)
      .to({ graphics: mask_1_graphics_118, x: 653.425, y: 255.525 })
      .wait(104));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(98).to({
      y: 318.05,
      alpha: 1,
    }, 0).to({ y: 433.25 }, 11, cjs.Ease.get(1))
      .to({ y: 413.25 }, 5, cjs.Ease.get(-1))
      .to({ y: 397.25 }, 4, cjs.Ease.get(1))
      .wait(104));
