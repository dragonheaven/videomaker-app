...
const template = (function (cjs, an) {
  ...
  (lib.head0012 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(58).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(19)
      .to({ _off: false }, 0)
      .wait(117));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(58).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(19)
      .to({ _off: false }, 0)
      .wait(117));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(58).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(19)
      .to({ _off: false }, 0)
      .wait(117));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(58).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(19)
      .to({ _off: false }, 0)
      .wait(6)
      ...
      .to({ scaleY: 1.0003, skewX: -1.2666, x: 44.75 }, 4)
      .to({
        scaleY: 1,
        skewX: 0,
        x: 43.9,
  ...
  (lib.head001b = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(113).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(159));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(113).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(159));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(113).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(159));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(113).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(159));
  ...
  (lib.char0012 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 20.6,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 39.3,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 20.7,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 38.4,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regY: 165.5,
      ...
      .to({
        scaleX: 1, scaleY: 1, rotation: 0, x: 90.4, y: 102,
      }, 5, cjs.Ease.get(1))
      .wait(120));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regY: 207.4,
      ...
      .to({ scaleX: 1, scaleY: 1, y: 144 }, 5, cjs.Ease.get(1))
      .wait(120));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(18).to({ startPosition: 18 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        rotation: 4.7379,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 15.5,
      ...
      .to({
        regX: 15.9, scaleY: 0.979, skewX: 4.8046, x: 121.45, y: 257.75,
      }, 4, cjs.Ease.get(-1))
      .to({
        regX: 15.8,
        regY: -18,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(48)
      .to({
        _off: false,
        regX: 15.8,
      ...
      .to({ scaleY: 1, skewX: 0, x: 71.55 }, 5, cjs.Ease.get(1))
      .wait(120));
  ...
  (lib.char001b = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(21).to({ startPosition: 21 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        rotation: 5.4751,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        regX: 14.6,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        regY: 14.6,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        regX: 14.8,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        regX: 20.6,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        rotation: 5.4751,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        rotation: -20.4812,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        rotation: 29.9992,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        regY: 10.9,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(21).to({ startPosition: 0 }, 0).to({ _off: true }, 1)
      .wait(45)
      .to({
        _off: false,
        skewX: -22.2453,
  ...
  (lib.char001 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 42.5,
      ...
      .wait(1)
      .to({ rotation: 4.8088, x: 111.5, y: -90.9 }, 0)
      .wait(1)
      .to({
        scaleX: 0.9999,
        scaleY: 0.9999,
      ...
      .wait(1)
      .to({
        scaleX: 1, scaleY: 1, rotation: 1.0115, x: 95.95, y: -91.65,
      }, 0)
      .wait(1)
      .to({
        rotation: 0.4496,
      ...
      .wait(1)
      .to({ rotation: 0.1124, x: 92, y: -91.85 }, 0)
      .wait(1)
      .to({
        regX: 42.9,
        regY: 48.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 14.7,
      ...
      .wait(1)
      .to({
        skewX: 2.1688, skewY: -177.8312, x: 197.95, y: 130.75,
      }, 0)
      .wait(1)
      .to({
        skewX: 1.796,
      ...
      .wait(1)
      .to({
        skewX: 0.4586, skewY: -179.5414, x: 173.4, y: 130.3,
      }, 0)
      .wait(1)
      .to({
        skewX: 0.2038,
      ...
      .wait(1)
      .to({
        skewX: 0.051, skewY: -179.949, x: 167.15, y: 130.1,
      }, 0)
      .wait(1)
      .to({
        regY: 8.1,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 18.5,
      ...
      .wait(1)
      .to({
        regX: 20.7, regY: 14.5, skewX: 0, skewY: 180, x: 160.25, y: 7.1,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 14.7,
      ...
      .wait(1)
      .to({ rotation: 6.027, x: 3.45, y: 121.55 }, 0)
      .wait(1)
      .to({
        regX: 14.8,
        regY: 8.1,
      ...
      .wait(1)
      .to({
        regX: 14.7, regY: 56.4, rotation: 2.759, x: 9.5, y: 126.25,
      }, 0)
      .wait(1)
      .to({
        scaleX: 0.9999,
      ...
      .wait(1)
      .to({
        scaleX: 1, scaleY: 1, rotation: 0.6897, x: 13.4, y: 129.25,
      }, 0)
      .wait(1)
      .to({
        rotation: 0.1724,
      ...
      .wait(1)
      .to({
        regY: 8.1, rotation: 0, x: 14.8, y: 81.9,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 18.5,
      ...
      .wait(1)
      .to({
        scaleX: 0.9997, scaleY: 0.9997, rotation: 12.5066, x: 21.05, y: 36.45,
      }, 0)
      .wait(1)
      .to({
        regX: 20.6,
      ...
      .wait(1)
      .to({
        scaleX: 0.9999, scaleY: 0.9999, rotation: 1.4503, x: 19.15, y: 41.7,
      }, 0)
      .wait(1)
      .to({
        scaleX: 1,
      ...
      .wait(1)
      .to({
        regX: 20.7, regY: 14.5, rotation: 0, x: 21.05, y: 7.1,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regY: 122,
      ...
      .wait(1)
      .to({ rotation: 4.8088, x: 97.55, y: 58.8 }, 0)
      .wait(1)
      .to({
        scaleX: 0.9999,
        scaleY: 0.9999,
      ...
      .wait(1)
      .to({
        scaleX: 1, scaleY: 1, rotation: 1.0115, x: 91.9, y: 58.55,
      }, 0)
      .wait(1)
      .to({
        rotation: 0.4496,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 24.4,
      ...
      .wait(1)
      .to({
        scaleX: 0.9999, scaleY: 0.9999, rotation: -1.7679, x: 119.9, y: 232.9,
      }, 0)
      .wait(1)
      .to({
        scaleX: 1,
      ...
      .wait(1)
      .to({
        regX: 22.6, regY: 10.8, rotation: 0, x: 116.05, y: 169.65,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 27,
      ...
      .wait(1)
      .to({
        scaleX: 0.9999, scaleY: 0.9999, rotation: 2.6069, x: 121.85, y: 334.05,
      }, 0)
      .wait(1)
      .to({
        scaleX: 1,
      ...
      .wait(1)
      .to({
        regX: 23.2, regY: 14.8, rotation: 0, x: 116.65, y: 286.5,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 24.4,
      ...
      .wait(1)
      .to({
        regX: 22.6, regY: 10.8, skewX: 0, skewY: -180, x: 64.75, y: 169.65,
      }, 0)
      .wait(114));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(67).to({ _off: false }, 0).wait(11)
      .to({ startPosition: 0 }, 0)
      .wait(1)
      .to({
        regX: 27,
      ...
      .wait(1)
      .to({
        regX: 23.2, regY: 14.8, skewX: 0, skewY: 180, x: 64.15, y: 286.5,
      }, 0)
      .wait(114));
  ...
  (lib.IndustryCompany7 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(72).to({ y: 604.45 }, 0).to({
      ...
      .to({ y: 273.2 }, 5, cjs.Ease.get(-1))
      .to({ y: 291.95 }, 5, cjs.Ease.get(1))
      .wait(98));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(75).to({ y: 729.45 }, 0).to({
      ...
      .to({ y: 398.2 }, 5, cjs.Ease.get(-1))
      .to({ y: 416.95 }, 5, cjs.Ease.get(1))
      .wait(95));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(35).to({ _off: false }, 0).to({
      ...
      .to({ y: 645.35, startPosition: 82 }, 4, cjs.Ease.get(-1))
      .to({
        y: 658.85,
        startPosition: 87,
      }, 5, cjs.Ease.get(1))
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(32).to({ _off: false }, 0).to({
      ...
      .to({ regY: 398.8, y: 631.75, startPosition: 82 }, 4, cjs.Ease.get(-1))
      .to({
        y: 644,
        startPosition: 87,
      }, 5, cjs.Ease.get(1))
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({ _off: false }, 0).to({
      ...
      .to({ y: 623.85, startPosition: 80 }, 4, cjs.Ease.get(-1))
      .to({
        regY: 398.9,
        y: 636,
        startPosition: 85,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape1).wait(19).to({
      y: 788.5,
      alpha: 1,
    }, 0).to({ y: 688.5 }, 16, cjs.Ease.get(1))
      .wait(155));
