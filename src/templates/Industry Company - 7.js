...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(58).to({startPosition:0},0).to({_off:true},1).wait(19).to({_off:false},0).wait(6).to({startPosition:0},0).to({scaleY:1.0035,skewX:-4.7486,x:47.1},7,cjs.Ease.get(1)).to({regX:49.8,scaleY:1.002,skewX:-1.2941,x:45,y:38.3},3,cjs.Ease.get(-1)).to({regX:49.7,scaleY:1.0005,skewX:1.8991,x:42.65,y:38.35},3,cjs.Ease.get(1)).to({scaleY:1.0003,skewX:-1.2666,x:44.75},4).to({scaleY:1,skewX:0,x:43.9},5,cjs.Ease.get(1)).wait(89));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:20.6,regY:4.6,skewX:2.7401,skewY:182.7401,x:195.4,y:100.05},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regX:20.7,scaleX:0.9999,scaleY:0.9999,skewX:1.5058,skewY:181.5058,x:179.85,y:90.4},4,cjs.Ease.get(-1)).to({regY:4.5,scaleX:1,scaleY:1,skewX:-8.2483,skewY:171.7517,x:149.5,y:82.15},5,cjs.Ease.get(1)).wait(120));

	// Layer_3
	this.instance_1 = new lib.bicep0012("synched",0);
	this.instance_1.setTransform(160.25,7.1,1,1,0,0,180,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:39.3,regY:3.1,skewX:-19.2143,skewY:160.7857,x:150.25,y:28.25},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regY:3,scaleX:0.9994,scaleY:0.9994,skewX:-10.5506,skewY:169.4494,x:146.4,y:13.65},4,cjs.Ease.get(-1)).to({regX:39.2,regY:3.1,scaleX:1,scaleY:1,skewX:7.4549,skewY:187.4549,x:141.75,y:-4.35},5,cjs.Ease.get(1)).wait(120));

	// Layer_4
	this.instance_2 = new lib.arm0012("synched",0);
	this.instance_2.setTransform(14.8,81.9,1,1,0,0,0,14.7,8.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:20.7,regY:3,rotation:29.9467,x:-8,y:81.1},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regX:20.6,scaleX:0.9991,scaleY:0.9991,rotation:16.5499,x:4.8,y:79.15},4,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,rotation:8.2483,x:35.05,y:82.6},5,cjs.Ease.get(1)).wait(120));

	// Layer_5
	this.instance_3 = new lib.bicep0012("synched",0);
	this.instance_3.setTransform(21.05,7.1,1,1,0,0,0,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:38.4,regY:3.9,rotation:29.9467,x:47.6,y:20.5},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9991,scaleY:0.9991,rotation:16.5499,x:43.75,y:9.95},4,cjs.Ease.get(-1)).to({regX:38.5,regY:3.7,scaleX:1,scaleY:1,rotation:-10.2103,x:38.85,y:-3.65},5,cjs.Ease.get(1)).wait(120));

	// Layer_13
	this.instance_4 = new lib.body00122("synched",0);
	this.instance_4.setTransform(90.4,144,1,1,0,0,0,77,207.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regY:165.5,scaleY:1.0211,rotation:4.7378,x:90.15,y:132.65},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9998,scaleY:0.9998,rotation:2.5331,x:90.35,y:117.5},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:0,x:90.4,y:102},5,cjs.Ease.get(1)).wait(120));

	// Layer_6
	this.instance_5 = new lib.body001copy("synched",0);
	this.instance_5.setTransform(90.4,144,1,1,0,0,0,77,207.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regY:207.4,scaleX:1.0671,scaleY:0.9113,x:90.35,y:169.8},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regY:207.5,scaleX:1.0969,scaleY:0.9507,x:90.4,y:158.35},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,y:144},5,cjs.Ease.get(1)).wait(120));

	// Layer_1
	this.instance_6 = new lib.head0012("synched",0);
	this.instance_6.setTransform(91.95,-84.75,1,1,0,0,0,42.9,48.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(18).to({startPosition:18},0).to({_off:true},1).wait(48).to({_off:false,rotation:4.7379,x:107.35,y:-56.05,startPosition:86},0).wait(8).to({startPosition:94},0).to({_off:true},1).wait(2).to({_off:false,startPosition:78},0).to({scaleX:0.9998,scaleY:0.9998,rotation:2.5331,x:100.5,y:-68.8,startPosition:82},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:0,x:91.95,y:-84.75,startPosition:87},5,cjs.Ease.get(1)).wait(120));

	// Layer_8
	this.instance_7 = new lib.leg0012("synched",0);
	this.instance_7.setTransform(116.65,286.5,1,1,0,0,0,23.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:15.5,regY:-17.9,scaleY:0.9581,skewX:6.9657,x:126,y:261},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false,regX:15.6,x:126.1},0).to({regX:15.9,scaleY:0.979,skewX:4.8046,x:121.45,y:257.75},4,cjs.Ease.get(-1)).to({regX:15.8,regY:-18,scaleY:1,skewX:0,x:109.25,y:253.7},5,cjs.Ease.get(1)).wait(120));

	// Layer_10
	this.instance_8 = new lib.leg0012("synched",0);
	this.instance_8.setTransform(64.15,286.5,1,1,0,0,180,23.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({startPosition:0},0).to({_off:true},1).wait(48).to({_off:false,regX:15.8,regY:-16.1,scaleY:1.0049,skewX:-5.6261,x:57.25,y:255.6},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleY:1.0044,skewX:-4.0264,x:61.05},4,cjs.Ease.get(-1)).to({scaleY:1,skewX:0,x:71.55},5,cjs.Ease.get(1)).wait(120));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(96).to({_off:false},0).to({regX:116,scaleX:1},14,cjs.Ease.get(1)).wait(91));

	// Layer_1
	this.instance_1 = new lib.head001b("synched",0);
	this.instance_1.setTransform(91.95,-84.75,1,1,0,0,0,42.9,48.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(21).to({startPosition:21},0).to({_off:true},1).wait(45).to({_off:false,rotation:5.4751,x:113.75,y:-83.55,startPosition:0},0).wait(8).to({startPosition:8},0).to({_off:true},1).wait(2).to({_off:false,startPosition:0},0).to({scaleX:0.9998,scaleY:0.9998,rotation:2.8097,x:103.85,y:-84.1},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:0,x:91.95,y:-84.75},5,cjs.Ease.get(1)).wait(114));

	// Layer_2
	this.instance_2 = new lib.arm001b("synched",0);
	this.instance_2.setTransform(166.5,81.9,1,1,0,0,180,14.7,8.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,regX:14.6,regY:8.2,skewX:2.4671,skewY:182.4671,x:204.2,y:82.7},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({skewX:1.274,skewY:181.274,x:187.05,y:82.45},4,cjs.Ease.get(-1)).to({regX:14.7,regY:8.1,skewX:0,skewY:180,x:166.5,y:81.9},5,cjs.Ease.get(1)).wait(4).to({startPosition:0},0).to({regY:8.2,skewX:55.4944,skewY:235.4944,x:190.9,y:73.2},8,cjs.Ease.get(-1)).wait(102));

	// Layer_3
	this.instance_3 = new lib.bicep001b("synched",0);
	this.instance_3.setTransform(160.25,7.1,1,1,0,0,180,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,regY:14.6,skewX:-19.7206,skewY:160.2794,x:173,y:14.45},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regY:14.5,scaleX:0.9994,scaleY:0.9994,skewX:-10.7585,skewY:169.2415,x:167.25,y:11.05},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:0,skewY:180,x:160.25,y:7.1},5,cjs.Ease.get(1)).wait(4).to({startPosition:0},0).to({skewX:-20.9898,skewY:159.0102},8,cjs.Ease.get(-1)).wait(102));

	// Layer_4
	this.instance_4 = new lib.arm001b("synched",0);
	this.instance_4.setTransform(14.8,81.9,1,1,0,0,0,14.7,8.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,regX:14.8,rotation:8.2335,x:6.4,y:70.65},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9998,scaleY:0.9998,rotation:4.3109,x:10.25,y:75.75},4,cjs.Ease.get(-1)).to({regX:14.7,scaleX:1,scaleY:1,rotation:0,x:14.8,y:81.9},5,cjs.Ease.get(1)).wait(4).to({startPosition:0},0).to({rotation:-53.6963,x:3.45,y:76.8},8,cjs.Ease.get(-1)).wait(102));

	// Layer_5
	this.instance_5 = new lib.bicep001b("synched",0);
	this.instance_5.setTransform(21.05,7.1,1,1,0,0,0,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,regX:20.6,rotation:16.9327,x:34.05,y:0.9},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9995,scaleY:0.9995,rotation:9.0641,x:28.15,y:3.75},4,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,rotation:0,x:21.05,y:7.1},5,cjs.Ease.get(1)).wait(4).to({startPosition:0},0).to({rotation:9.4951,x:21},8,cjs.Ease.get(-1)).wait(102));

	// Layer_6
	this.instance_6 = new lib.body001b("synched",0);
	this.instance_6.setTransform(90.4,144,1,1,0,0,0,77,207.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,rotation:5.4751},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regY:207.4,scaleX:0.9998,scaleY:0.9998,rotation:2.8097,y:143.9},4,cjs.Ease.get(-1)).to({regY:207.5,scaleX:1,scaleY:1,rotation:0,y:144},5,cjs.Ease.get(1)).wait(114));

	// Layer_7
	this.instance_7 = new lib.upleg001b("synched",0);
	this.instance_7.setTransform(116.05,169.65,1,1,0,0,0,22.6,10.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,rotation:-20.4812,y:155.3},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regX:22.5,scaleX:0.9994,scaleY:0.9994,rotation:-11.0493,x:115.95,y:161.8},4,cjs.Ease.get(-1)).to({regX:22.6,scaleX:1,scaleY:1,rotation:0,x:116.05,y:169.65},5,cjs.Ease.get(1)).wait(114));

	// Layer_8
	this.instance_8 = new lib.leg001b("synched",0);
	this.instance_8.setTransform(116.65,286.5,1,1,0,0,0,23.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,rotation:29.9992,x:159.3,y:262.5},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9991,scaleY:0.9991,rotation:16.2932,x:139.9,y:273.4},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:0,x:116.65,y:286.5},5,cjs.Ease.get(1)).wait(114));

	// Layer_9
	this.instance_9 = new lib.upleg001b("synched",0);
	this.instance_9.setTransform(64.75,169.65,1,1,0,0,180,22.6,10.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,regY:10.9,skewX:29.9992,skewY:209.9992,x:70.8,y:159.9},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({regY:11,scaleX:0.9991,scaleY:0.9991,skewX:16.2932,skewY:196.2932,x:68.05,y:164.4},4,cjs.Ease.get(-1)).to({regY:10.8,scaleX:1,scaleY:1,skewX:0,skewY:180,x:64.75,y:169.65},5,cjs.Ease.get(1)).wait(114));

	// Layer_10
	this.instance_10 = new lib.leg001b("synched",0);
	this.instance_10.setTransform(64.15,286.5,1,1,0,0,180,23.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(21).to({startPosition:0},0).to({_off:true},1).wait(45).to({_off:false,skewX:-22.2453,skewY:157.7547,x:12.4,y:261.75},0).wait(8).to({startPosition:0},0).to({_off:true},1).wait(2).to({_off:false},0).to({scaleX:0.9993,scaleY:0.9993,skewX:-12.0417,skewY:167.9583,x:35.9,y:273},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:0,skewY:180,x:64.15,y:286.5},5,cjs.Ease.get(1)).wait(114));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:42.5,regY:41.3,rotation:5.3085,x:113.4,y:-90.8},0).wait(1).to({rotation:4.8088,x:111.5,y:-90.9},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:3.9758,x:108.3,y:-91.1},0).wait(1).to({regX:42.9,regY:48.5,scaleX:0.9998,scaleY:0.9998,rotation:2.8097,x:103.85,y:-84.1},0).wait(1).to({regX:42.5,regY:41.3,scaleX:0.9999,scaleY:0.9999,rotation:1.7982,x:99.35,y:-91.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:1.0115,x:95.95,y:-91.65},0).wait(1).to({rotation:0.4496,x:93.5,y:-91.75},0).wait(1).to({rotation:0.1124,x:92,y:-91.85},0).wait(1).to({regX:42.9,regY:48.5,rotation:0,x:91.95,y:-84.75},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:14.7,regY:56.4,skewX:2.3925,skewY:-177.6075,x:201,y:130.85},0).wait(1).to({skewX:2.1688,skewY:-177.8312,x:197.95,y:130.75},0).wait(1).to({skewX:1.796,skewY:-178.204,x:192.95,y:130.7},0).wait(1).to({regX:14.6,regY:8.2,skewX:1.274,skewY:-178.726,x:187.05,y:82.45},0).wait(1).to({regX:14.7,regY:56.4,skewX:0.8153,skewY:-179.1847,x:178.85,y:130.4},0).wait(1).to({skewX:0.4586,skewY:-179.5414,x:173.4,y:130.3},0).wait(1).to({skewX:0.2038,skewY:-179.7962,x:169.5,y:130.15},0).wait(1).to({skewX:0.051,skewY:-179.949,x:167.15,y:130.1},0).wait(1).to({regY:8.1,skewX:0,skewY:-180,x:166.5,y:81.9},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:18.5,regY:49.7,skewX:-19.1605,skewY:160.8395,x:186.2,y:46.65},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,skewX:-17.4801,skewY:162.5199,x:184.15,y:46.45},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,skewX:-14.6794,skewY:165.3206,x:180.7,y:45.95},0).wait(1).to({regX:20.7,regY:14.5,scaleX:0.9994,scaleY:0.9994,skewX:-10.7585,skewY:169.2415,x:167.25,y:11.05},0).wait(1).to({regX:18.5,regY:49.7,scaleX:0.9996,scaleY:0.9996,skewX:-6.8855,skewY:173.1145,x:171.1,y:44.3},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,skewX:-3.8731,skewY:176.1269,x:167.35,y:43.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,skewX:-1.7214,skewY:178.2786,x:164.65,y:42.85},0).wait(1).to({scaleX:1,scaleY:1,skewX:-0.4303,skewY:179.5697,x:163,y:42.5},0).wait(1).to({regX:20.7,regY:14.5,skewX:0,skewY:180,x:160.25,y:7.1},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:14.7,regY:56.4,rotation:7.9883,x:-0.15,y:118.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:7.2528,x:1.25,y:119.8},0).wait(1).to({rotation:6.027,x:3.45,y:121.55},0).wait(1).to({regX:14.8,regY:8.1,scaleX:0.9998,scaleY:0.9998,rotation:4.3109,x:10.25,y:75.75},0).wait(1).to({regX:14.7,regY:56.4,rotation:2.759,x:9.5,y:126.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.5519,x:11.75,y:127.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.6897,x:13.4,y:129.25},0).wait(1).to({rotation:0.1724,x:14.4,y:130},0).wait(1).to({regY:8.1,rotation:0,x:14.8,y:81.9},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:18.5,regY:49.7,rotation:16.4409,x:21.7,y:34.3},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:14.9656,x:21.4,y:35.15},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,rotation:12.5066,x:21.05,y:36.45},0).wait(1).to({regX:20.6,regY:14.5,scaleX:0.9995,scaleY:0.9995,rotation:9.0641,x:28.15,y:3.75},0).wait(1).to({regX:18.5,regY:49.7,scaleX:0.9997,scaleY:0.9997,rotation:5.801,x:19.95,y:39.8},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:3.2631,x:19.4,y:40.9},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.4503,x:19.15,y:41.7},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3626,x:18.95,y:42.15},0).wait(1).to({regX:20.7,regY:14.5,rotation:0,x:21.05,y:7.1},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regY:122,rotation:5.3085,x:98.25,y:58.9},0).wait(1).to({rotation:4.8088,x:97.55,y:58.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:3.9758,x:96.3,y:58.75},0).wait(1).to({regY:207.4,scaleX:0.9998,scaleY:0.9998,rotation:2.8097,x:90.4,y:143.9},0).wait(1).to({regY:122,scaleX:0.9999,scaleY:0.9999,rotation:1.7982,x:93,y:58.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:1.0115,x:91.9,y:58.55},0).wait(1).to({rotation:0.4496,x:91.05,y:58.6},0).wait(1).to({rotation:0.1124,x:90.55},0).wait(1).to({regY:207.5,rotation:0,x:90.4,y:144},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:24.4,regY:75.4,rotation:-19.8917,x:139.7,y:215.8},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:-18.1233,x:137.85,y:217.7},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,rotation:-15.1758,x:134.7,y:220.75},0).wait(1).to({regX:22.5,regY:10.8,scaleX:0.9994,scaleY:0.9994,rotation:-11.0493,x:115.95,y:161.8},0).wait(1).to({regX:24.4,regY:75.4,scaleX:0.9996,scaleY:0.9996,rotation:-7.0716,x:125.8,y:228.45},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:-3.9778,x:122.4,y:231.1},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.7679,x:119.9,y:232.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.442,x:118.4,y:233.95},0).wait(1).to({regX:22.6,regY:10.8,rotation:0,x:116.05,y:169.65},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:27,regY:64.4,scaleX:0.9999,scaleY:0.9999,rotation:29.1426,x:137.25,y:308.35},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:26.5727,x:135.65,y:311.25},0).wait(1).to({scaleX:0.9995,scaleY:0.9995,rotation:22.2896,x:133.05,y:315.95},0).wait(1).to({regX:23.2,regY:14.8,scaleX:0.9991,scaleY:0.9991,rotation:16.2932,x:139.9,y:273.4},0).wait(1).to({regX:27,regY:64.4,scaleX:0.9994,scaleY:0.9994,rotation:10.4277,x:126.3,y:327.55},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,rotation:5.8656,x:123.7,y:331.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:2.6069,x:121.85,y:334.05},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.6517,x:120.8,y:335.55},0).wait(1).to({regX:23.2,regY:14.8,rotation:0,x:116.65,y:286.5},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:24.4,regY:75.4,scaleX:0.9999,scaleY:0.9999,skewX:29.1426,skewY:-150.8574,x:37.65,y:215.6},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,skewX:26.5727,skewY:-153.4273,x:39.65,y:217.85},0).wait(1).to({scaleX:0.9995,scaleY:0.9995,skewX:22.2896,skewY:-157.7104,x:43.1,y:221.35},0).wait(1).to({regX:22.6,regY:11,scaleX:0.9991,scaleY:0.9991,skewX:16.2932,skewY:-163.7068,x:68.05,y:164.4},0).wait(1).to({regX:24.4,regY:75.4,scaleX:0.9994,scaleY:0.9994,skewX:10.4277,skewY:-169.5723,x:53.4,y:229.3},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,skewX:5.8656,skewY:-174.1344,x:57.6,y:231.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,skewX:2.6069,skewY:-177.3931,x:60.55,y:233.1},0).wait(1).to({scaleX:1,scaleY:1,skewX:0.6517,skewY:-179.3483,x:62.4,y:233.85},0).wait(1).to({regX:22.6,regY:10.8,skewX:0,skewY:-180,x:64.75,y:169.65},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(67).to({_off:false},0).wait(11).to({startPosition:0},0).wait(1).to({regX:27,regY:64.4,skewX:-21.6075,skewY:158.3925,x:28.55,y:309.9},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,skewX:-19.6944,skewY:160.3056,x:31.35,y:312.5},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,skewX:-16.5058,skewY:163.4942,x:35.95,y:316.65},0).wait(1).to({regX:23.2,regY:14.8,scaleX:0.9993,scaleY:0.9993,skewX:-12.0417,skewY:167.9583,x:35.9,y:273},0).wait(1).to({regX:27,regY:64.4,scaleX:0.9996,scaleY:0.9996,skewX:-7.7067,skewY:172.2933,x:48.9,y:327.45},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,skewX:-4.335,skewY:175.665,x:53.9,y:331.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,skewX:-1.9267,skewY:178.0733,x:57.45,y:333.95},0).wait(1).to({scaleX:1,scaleY:1,skewX:-0.4817,skewY:179.5183,x:59.6,y:335.55},0).wait(1).to({regX:23.2,regY:14.8,skewX:0,skewY:180,x:64.15,y:286.5},0).wait(114));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape10).wait(6).to({x:640},0).to({regY:359.8,scaleY:0.0511,x:640.05,y:360},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(147).to({alpha:1},0).to({regY:360,scaleY:1.8473,x:640,y:359.95},17,cjs.Ease.get(1)).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape12).wait(10).to({regY:358.9,scaleY:0.0307,skewX:-32.6941,y:359.95},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(139).to({alpha:1},0).to({regY:360,scaleY:1.8615,skewX:-32.6892,y:360},17,cjs.Ease.get(1)).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape13).wait(12).to({regY:358.4,scaleY:0.0508,skewX:-32.6877,y:359.85},16,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(135).to({alpha:1},0).to({regY:360,scaleY:1.8378,skewX:-32.689,y:359.95},17,cjs.Ease.get(1)).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.text1).wait(72).to({y:604.45},0).to({y:254.45,alpha:1},10,cjs.Ease.get(1)).to({y:273.2},5,cjs.Ease.get(-1)).to({y:291.95},5,cjs.Ease.get(1)).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.text2).wait(75).to({y:729.45},0).to({y:379.45,alpha:1},10,cjs.Ease.get(1)).to({y:398.2},5,cjs.Ease.get(-1)).to({y:416.95},5,cjs.Ease.get(1)).wait(95));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(35).to({_off:false},0).to({y:634.5,startPosition:78},9,cjs.Ease.get(1)).to({y:645.35,startPosition:82},4,cjs.Ease.get(-1)).to({y:658.85,startPosition:87},5,cjs.Ease.get(1)).to({_off:true},136).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(32).to({_off:false},0).to({regY:398.7,y:621.85,startPosition:78},9,cjs.Ease.get(1)).to({regY:398.8,y:631.75,startPosition:82},4,cjs.Ease.get(-1)).to({y:644,startPosition:87},5,cjs.Ease.get(1)).to({_off:true},139).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({y:614.25,startPosition:76},9,cjs.Ease.get(1)).to({y:623.85,startPosition:80},4,cjs.Ease.get(-1)).to({regY:398.9,y:636,startPosition:85},5,cjs.Ease.get(1)).to({_off:true},142).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape1).wait(19).to({y:788.5,alpha:1},0).to({y:688.5},16,cjs.Ease.get(1)).wait(155));
