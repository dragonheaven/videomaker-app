...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:289.85,y:126.725}).wait(155).to({graphics:mask_graphics_155,x:289.85,y:126.725}).wait(1).to({graphics:null,x:0,y:0}).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3,p:{x:200.2}},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_9},{t:this.shape_2},{t:this.shape_1},{t:this.shape_3,p:{x:366.2}}]},155).to({state:[]},1).wait(158));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(27).to({startPosition:0},0).to({regX:14,scaleX:0.999,scaleY:1.0729,skewX:-19.5353,skewY:160.4643,x:201.7,y:206.55},6,cjs.Ease.get(-1)).to({regX:13.9,scaleX:1,scaleY:1.074,skewX:-15.0624,skewY:164.9383,x:201.85,y:206.5},6,cjs.Ease.get(1)).wait(20).to({startPosition:0},0).to({regX:14,scaleX:0.9985,scaleY:1.0725,skewX:-30.0867,skewY:149.9108,x:201.75,y:206.55},6,cjs.Ease.get(-1)).to({regX:13.8,scaleX:1,scaleY:1.074,skewX:-42.7431,skewY:137.2571,x:201.85,y:206.45},5,cjs.Ease.get(1)).wait(30).to({startPosition:0},0).to({regX:13.9,skewX:-24.0513,skewY:155.949},11).wait(24));

	// Layer_2
	this.instance_2 = new lib.Symbol10("synched",0);
	this.instance_2.setTransform(50.15,210.55,1,1.074,24.0513,0,0,15.5,20.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(18).to({startPosition:0},0).to({scaleX:0.9989,scaleY:1.0729,rotation:19.8186,x:50.25},6,cjs.Ease.get(-1)).to({regX:15.6,scaleX:1,scaleY:1.074,rotation:15.8223,y:210.6},6,cjs.Ease.get(1)).wait(38).to({startPosition:0},0).to({scaleX:0.9987,scaleY:1.0726,rotation:26.0427,x:50.2,y:210.65},6,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1.074,rotation:34.5245,x:50.25,y:210.6},5,cjs.Ease.get(1)).wait(31).to({startPosition:0},0).to({regX:15.5,rotation:24.0513,x:50.15,y:210.55},11).wait(14));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(17).to({_off:false},0).to({y:294.45,startPosition:10},10,cjs.Ease.get(1)).to({y:315.7,startPosition:16},6,cjs.Ease.get(-1)).to({y:333.45,startPosition:19},5,cjs.Ease.get(1)).wait(113).to({startPosition:132},0).to({_off:true},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},0).to({scaleX:1.1831,scaleY:1.1831},7,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},8,cjs.Ease.get(1)).wait(126).to({startPosition:0},0).to({_off:true},1).wait(4));

	// Layer_3
	this.instance_2 = new lib.Symbol7("synched",0);
	this.instance_2.setTransform(239.55,52.05,0.1768,0.1768,0,0,0,289.9,191.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:191.1,scaleX:1.129,scaleY:1.129,x:239.6,startPosition:10},10,cjs.Ease.get(1)).to({scaleX:0.911,scaleY:0.911,startPosition:16},6).to({scaleX:1,scaleY:1,startPosition:24},8,cjs.Ease.get(1)).wait(127).to({startPosition:151},0).to({_off:true},1).wait(4));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape10).wait(8).to({x:1931.5},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(136).to({x:-651.5,alpha:1},0).to({x:640},15,cjs.Ease.get(1)).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape9).wait(14).to({x:1931.5},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(127).to({x:-651.5,alpha:1},0).to({x:640},15,cjs.Ease.get(1)).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape8).wait(16).to({x:1931.5},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(122).to({x:-651.5,alpha:1},0).to({x:640},15,cjs.Ease.get(1)).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.text1).wait(58).to({x:1593.05,alpha:1},0).to({x:994.55},8,cjs.Ease.get(1)).to({x:1026.05},4,cjs.Ease.get(-1)).to({x:1057.55},4,cjs.Ease.get(1)).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.text2).wait(64).to({x:1593.05,alpha:1},0).to({x:994.55},8,cjs.Ease.get(1)).to({x:1026.05},4,cjs.Ease.get(-1)).to({x:1057.55},4,cjs.Ease.get(1)).wait(97));
