...
const template = (function (cjs, an) {
  ...
  (lib.Symbol7 = function (mode, startPosition, loop, reversed) {
    ...
    mask._off = true;
    const mask_graphics_0 = new cjs.Graphics().p('EgqTAQpIAA/4QAAhZBdAAMBRtAAAQBdAAAABZIAAf4g');
    const mask_graphics_155 = new cjs.Graphics().p('EgqTAQpIAA/4QAAhZBdAAMBRtAAAQBdAAAABZIAAf4g');

    this.timeline.addTween(cjs.Tween.get(mask).to({
      graphics: mask_graphics_0,
      x: 289.85,
      y: 126.725,
    }).wait(155).to({ graphics: mask_graphics_155, x: 289.85, y: 126.725 })
      .wait(1)
      .to({
        graphics: null,
        x: 0,
  ...
  (lib.Symbol12 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(17).to({ _off: false }, 0).to({
      ...
      .to({ y: 315.7, startPosition: 16 }, 6, cjs.Ease.get(-1))
      .to({
        y: 333.45,
        startPosition: 19,
      }, 5, cjs.Ease.get(1))
      .wait(113)
      .to({ startPosition: 132 }, 0)
      .to({ _off: true }, 1)
      .wait(4));
  ...
  (lib.IndustryCompany3 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape10).wait(8).to({ x: 1931.5 }, 13, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(136)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape9).wait(14).to({ x: 1931.5 }, 13, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(127)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape8).wait(16).to({ x: 1931.5 }, 13, cjs.Ease.get(-1)).wait(1)
      .to({ alpha: 0 }, 0)
      .wait(122)
      .to({
        x: -651.5,
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(58).to({
      x: 1593.05,
      alpha: 1,
    }, 0).to({ x: 994.55 }, 8, cjs.Ease.get(1))
      .to({ x: 1026.05 }, 4, cjs.Ease.get(-1))
      .to({ x: 1057.55 }, 4, cjs.Ease.get(1))
      .wait(103));
