...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:52.6,y:207.9},14,cjs.Ease.get(1)).wait(25).to({startPosition:0},0).to({regY:8.2,scaleX:0.9985,scaleY:0.9985,rotation:-33.5871,x:66.8,y:203.7},6,cjs.Ease.get(-1)).to({regY:8.1,scaleX:1,scaleY:1,rotation:-67.2331,x:95,y:200.65},6,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({scaleX:0.9986,scaleY:0.9986,rotation:-63.4013,x:99.65,y:200.5},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-59.2703,x:104.3,y:200.4},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9986,scaleY:0.9986,rotation:-62.6934,x:100.3,y:200.5},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-67.2331,x:95,y:200.65},4,cjs.Ease.get(1)).to({scaleX:0.9986,scaleY:0.9986,rotation:-63.4013,x:99.65,y:200.5},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-59.2703,x:104.3,y:200.4},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9986,scaleY:0.9986,rotation:-62.6934,x:100.3,y:200.5},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-67.2331,x:95,y:200.65},4,cjs.Ease.get(1)).to({scaleX:0.9986,scaleY:0.9986,rotation:-63.4013,x:99.65,y:200.5},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-59.2703,x:104.3,y:200.4},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9986,scaleY:0.9986,rotation:-62.6934,x:100.3,y:200.5},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-67.2331,x:95,y:200.65},4,cjs.Ease.get(1)).wait(3).to({startPosition:0},0).to({scaleX:0.9984,scaleY:0.9984,rotation:-36.1158,x:75.4,y:204.05},6,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:0,x:52.6,y:207.9},7,cjs.Ease.get(1)).wait(39).to({startPosition:0},0).to({_off:true},1).wait(144));

	// Layer_3
	this.instance_1 = new lib.bicep001("synched",0);
	this.instance_1.setTransform(-224.05,124.1,1,1,0,0,0,20.7,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:58.85,y:133.1},14,cjs.Ease.get(1)).wait(25).to({startPosition:0},0).to({scaleX:0.9994,scaleY:0.9994,rotation:-11.0363,x:58.5,y:130.4},6,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-32.9505,x:59.8,y:135.25},6,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,rotation:-35.0781,x:60.7,y:135.2},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-37.1796,x:61.75},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:20.6,scaleX:0.9984,scaleY:0.9984,rotation:-35.3417,x:60.85},3,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,rotation:-32.9505,x:59.8,y:135.25},4,cjs.Ease.get(1)).to({scaleX:0.9985,scaleY:0.9985,rotation:-35.0781,x:60.7,y:135.2},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-37.1796,x:61.75},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:20.6,scaleX:0.9984,scaleY:0.9984,rotation:-35.3417,x:60.85},3,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,rotation:-32.9505,x:59.8,y:135.25},4,cjs.Ease.get(1)).to({scaleX:0.9985,scaleY:0.9985,rotation:-35.0781,x:60.7,y:135.2},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-37.1796,x:61.75},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:20.6,scaleX:0.9984,scaleY:0.9984,rotation:-35.3417,x:60.85},3,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,rotation:-32.9505,x:59.8,y:135.25},4,cjs.Ease.get(1)).wait(3).to({startPosition:0},0).to({regY:14.6,scaleX:0.9991,scaleY:0.9991,rotation:-17.5765,x:59.35,y:134.3},6,cjs.Ease.get(-1)).to({regY:14.5,scaleX:1,scaleY:1,rotation:0,x:58.85,y:133.1},7,cjs.Ease.get(1)).wait(39).to({startPosition:0},0).to({_off:true},1).wait(144));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({y:198.9},14,cjs.Ease.get(1)).wait(25).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,skewX:32.3079,skewY:212.3079,x:283.8,y:196.65},7,cjs.Ease.get(-1)).to({regX:14.6,scaleX:1,scaleY:1,skewX:64.5364,skewY:244.5364,x:260.3,y:194.45},7,cjs.Ease.get(1)).wait(2).to({startPosition:0},0).to({scaleX:0.9986,scaleY:0.9986,skewX:60.4359,skewY:240.4359,x:255.6,y:196.1},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:56.3141,skewY:236.3141,x:250.85,y:197.6},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:14.7,scaleX:0.9986,scaleY:0.9986,skewX:59.912,skewY:239.912,x:254.9,y:196.15},3,cjs.Ease.get(-1)).to({regX:14.6,scaleX:1,scaleY:1,skewX:64.5364,skewY:244.5364,x:260.3,y:194.45},4,cjs.Ease.get(1)).to({scaleX:0.9986,scaleY:0.9986,skewX:60.4359,skewY:240.4359,x:255.6,y:196.1},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:56.3141,skewY:236.3141,x:250.85,y:197.6},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:14.7,scaleX:0.9986,scaleY:0.9986,skewX:59.912,skewY:239.912,x:254.9,y:196.15},3,cjs.Ease.get(-1)).to({regX:14.6,scaleX:1,scaleY:1,skewX:64.5364,skewY:244.5364,x:260.3,y:194.45},4,cjs.Ease.get(1)).to({scaleX:0.9986,scaleY:0.9986,skewX:60.4359,skewY:240.4359,x:255.6,y:196.1},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:56.3141,skewY:236.3141,x:250.85,y:197.6},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({regX:14.7,scaleX:0.9986,scaleY:0.9986,skewX:59.912,skewY:239.912,x:254.9,y:196.15},3,cjs.Ease.get(-1)).to({regX:14.6,scaleX:1,scaleY:1,skewX:64.5364,skewY:244.5364,x:260.3,y:194.45},4,cjs.Ease.get(1)).wait(3).to({startPosition:0},0).wait(5).to({startPosition:0},0).to({regX:14.7,scaleX:0.9985,scaleY:0.9985,skewX:30.0763,skewY:210.0763,x:285.3,y:196.8},8,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:0,skewY:180,x:307.3,y:198.9},7,cjs.Ease.get(1)).wait(32).to({startPosition:0},0).to({_off:true},1).wait(144));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(6).to({_off:false},0).to({y:124.1},14,cjs.Ease.get(1)).wait(25).to({startPosition:0},0).to({regX:20.6,scaleX:0.9992,scaleY:0.9992,skewX:15.0717,skewY:195.0717,x:297,y:127},7,cjs.Ease.get(-1)).to({regX:20.7,scaleX:1,scaleY:1,skewX:30.469,skewY:210.469,x:292.7,y:129.85},7,cjs.Ease.get(1)).wait(2).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,skewX:32.5761,skewY:212.5761,y:129.8},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:34.7042,skewY:214.7042,x:292.75,y:129.85},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,skewX:32.8403,skewY:212.8403,x:292.7},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:30.469,skewY:210.469},4,cjs.Ease.get(1)).to({scaleX:0.9985,scaleY:0.9985,skewX:32.5761,skewY:212.5761,y:129.8},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:34.7042,skewY:214.7042,x:292.75,y:129.85},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,skewX:32.8403,skewY:212.8403,x:292.7},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:30.469,skewY:210.469},4,cjs.Ease.get(1)).to({scaleX:0.9985,scaleY:0.9985,skewX:32.5761,skewY:212.5761,y:129.8},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:34.7042,skewY:214.7042,x:292.75,y:129.85},4,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({scaleX:0.9985,scaleY:0.9985,skewX:32.8403,skewY:212.8403,x:292.7},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewX:30.469,skewY:210.469},4,cjs.Ease.get(1)).wait(3).to({startPosition:0},0).wait(5).to({startPosition:0},0).to({regY:14.6,scaleX:0.9992,scaleY:0.9992,skewX:14.0657,skewY:194.0657,x:297.25,y:126.9},8,cjs.Ease.get(-1)).to({regY:14.5,scaleX:1,scaleY:1,skewX:0,skewY:180,x:301.05,y:124.1},7,cjs.Ease.get(1)).wait(32).to({startPosition:0},0).to({_off:true},1).wait(144));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape10).wait(9).to({regY:359.9,scaleX:0.1189,scaleY:0.1189},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(147).to({scaleX:0.1402,scaleY:0.1402,alpha:1},0).to({regY:360,scaleX:1,scaleY:1},16,cjs.Ease.get(1)).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape9).wait(12).to({regY:359.9,scaleX:0.1189,scaleY:0.1189},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(140).to({scaleX:0.1402,scaleY:0.1402,alpha:1},0).to({regY:360,scaleX:1,scaleY:1},16,cjs.Ease.get(1)).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape8).wait(14).to({regY:359.9,scaleX:0.1189,scaleY:0.1189},13,cjs.Ease.get(-1)).wait(1).to({alpha:0},0).wait(136).to({scaleX:0.1402,scaleY:0.1402,alpha:1},0).to({regY:360,scaleX:1,scaleY:1},16,cjs.Ease.get(1)).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.text1).wait(54).to({scaleX:0.2806,scaleY:0.2806,alpha:1},0).to({scaleX:1.1909,scaleY:1.1909},8,cjs.Ease.get(1)).to({regX:360.9,scaleX:1.0301,scaleY:1.0301,x:885.55,y:291.45},3,cjs.Ease.get(-1)).to({regX:360.8,scaleX:0.8694,scaleY:0.8694,x:885.45,y:291.5},3,cjs.Ease.get(1)).to({scaleX:0.9254,scaleY:0.9254,x:885.5},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:885.45},4,cjs.Ease.get(1)).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.text2).wait(65).to({scaleX:0.3621,scaleY:0.3621,alpha:1},0).to({scaleX:1.1855,scaleY:1.1855},8,cjs.Ease.get(1)).to({regX:360.9,scaleX:1.0275,scaleY:1.0275,x:885.5},3,cjs.Ease.get(-1)).to({regX:360.8,scaleX:0.8693,scaleY:0.8693,x:885.45},3,cjs.Ease.get(1)).to({scaleX:0.9253,scaleY:0.9253},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1},4,cjs.Ease.get(1)).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape1).wait(23).to({y:770.75,alpha:1},0).to({y:671.55},12,cjs.Ease.get(1)).wait(154));
