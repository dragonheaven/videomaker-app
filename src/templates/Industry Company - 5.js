...
const template = (function (cjs, an) {
  ...
  (lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).to({
      x: 52.6,
      y: 207.9,
    }, 14, cjs.Ease.get(1)).wait(25).to({ startPosition: 0 }, 0)
      .to({
        regY: 8.2,
        scaleX: 0.9985,
        scaleY: 0.9985,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_2).to({ x: 61 }, 14, cjs.Ease.get(1)).wait(98).to({ startPosition: 0 }, 0)
      .wait(52)
      .to({ startPosition: 0 }, 0)
      .to({ _off: true }, 1)
      .wait(144));
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({ _off: false }, 0).to({ y: 261.6 }, 14, cjs.Ease.get(1))
      .wait(92)
      .to({ startPosition: 0 }, 0)
      .wait(52)
      .to({ startPosition: 0 }, 0)
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({ _off: false }, 0).to({ y: 198.9 }, 14, cjs.Ease.get(1))
      .wait(25)
      .to({ startPosition: 0 }, 0)
      .to({
        scaleX: 0.9985,
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(6).to({ _off: false }, 0).to({ y: 124.1 }, 14, cjs.Ease.get(1))
      .wait(25)
      .to({ startPosition: 0 }, 0)
      .to({
        regX: 20.6,
  ...
  (lib.IndustryCompany5 = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape10).wait(9).to({
      ...
      .to({ regY: 360, scaleX: 1, scaleY: 1 }, 16, cjs.Ease.get(1))
      .wait(3));
    ...
    this.timeline.addTween(cjs.Tween.get(this.text1).wait(54).to({
      ...
      scaleY: 0.2806,
      alpha: 1,
    }, 0).to({ scaleX: 1.1909, scaleY: 1.1909 }, 8, cjs.Ease.get(1))
      .to({
        regX: 360.9,
        scaleX: 1.0301,
        scaleY: 1.0301,
      ...
      .to({ scaleX: 0.9254, scaleY: 0.9254, x: 885.5 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
        x: 885.45,
    ...
    this.timeline.addTween(cjs.Tween.get(this.text2).wait(65).to({
      ...
      scaleY: 0.3621,
      alpha: 1,
    }, 0).to({ scaleX: 1.1855, scaleY: 1.1855 }, 8, cjs.Ease.get(1))
      .to({
        regX: 360.9,
        scaleX: 1.0275,
        scaleY: 1.0275,
      ...
      .to({ scaleX: 0.9253, scaleY: 0.9253 }, 3, cjs.Ease.get(-1))
      .to({
        scaleX: 1,
        scaleY: 1,
      }, 4, cjs.Ease.get(1))
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({ _off: false }, 0).to({ _off: true }, 165)
      .wait(1));
    ...
    this.timeline.addTween(cjs.Tween.get(this.shape1).wait(23).to({
      y: 770.75,
      alpha: 1,
    }, 0).to({ y: 671.55 }, 12, cjs.Ease.get(1))
      .wait(154));
