...
const TimelineStyleUtils = /** @class */ (function () {
  ...
  TimelineStyleUtils.keyframeShape = function (keyframe, rowStyle, options) {
    const shape = TimelineStyleUtils.getKeyframeStyle(keyframe, rowStyle, options, 'shape', timelineKeyframeShape_1.TimelineKeyframeShape.Rhomb);
    return shape;
  };
